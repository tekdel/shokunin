...
-- Quckfix list
vim.keymap.set('n', '<leader>qo', ':copen<CR>', { desc = 'Open [Q]uickfix list and stay in current window' })
vim.keymap.set('n', '<leader>qc', ':cclose<CR>', { desc = 'Close [Q]uickfix list and stay in current window' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'typescript', 'rust', 'go' },
...

  {
    ...
    init = function()
      ...
      vim.keymap.set('n', '<leader>to', neotest.output_panel.toggle, { desc = '[T]est [O]utput' })
    end,
  },
